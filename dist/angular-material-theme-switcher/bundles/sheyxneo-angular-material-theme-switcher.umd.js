(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/material'), require('@angular/cdk/overlay'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('@sheyxneo/angular-material-theme-switcher', ['exports', '@angular/core', '@angular/common', '@angular/material', '@angular/cdk/overlay', 'rxjs'], factory) :
    (global = global || self, factory((global.sheyxneo = global.sheyxneo || {}, global.sheyxneo['angular-material-theme-switcher'] = {}), global.ng.core, global.ng.common, global.ng.material, global.ng.cdk.overlay, global.rxjs));
}(this, function (exports, core, common, material, overlay, rxjs) { 'use strict';
    ...
    var AmThemeService = /** @class */ (function () {
        function AmThemeService() {
            ...
            this.colorTheme$ = new rxjs.BehaviorSubject('indigo-pink');
            this.isDark$ = new rxjs.BehaviorSubject(false);
        }
    ...
    var ColorSwitcherComponent = /** @class */ (function () {
        ...
        ColorSwitcherComponent.propDecorators = {
            colorTheme: [{ type: core.Input }],
            themes: [{ type: core.Input }],
            isUseLibraryThemes: [{ type: core.Input }]
        };
    ...
    var ContainerDirective = /** @class */ (function () {
        ...
        ContainerDirective.propDecorators = {
            colorTheme: [{ type: core.Input }],
            isDark: [{ type: core.Input }],
            themeActiveCssClass: [{ type: core.HostBinding, args: ['class',] }]
        };
    ...
    exports.AmThemeService = AmThemeService;
    exports.AngularMaterialThemeSwitcherModule = AngularMaterialThemeSwitcherModule;
    exports.ɵa = ColorSwitcherComponent;
    exports.ɵb = DarkSwitcherComponent;
    exports.ɵc = ContainerDirective;
    exports.ɵd = ActiveDirective;
    exports.ɵe = CustomDirective;
    exports.ɵf = DarkDirective;
    exports.ɵg = LightDirective;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=sheyxneo-angular-material-theme-switcher.umd.js.map
